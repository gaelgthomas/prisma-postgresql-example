  ...
  */
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
          P extends 'Tweet'
        ? Array < TweetGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
          P extends 'Tweet'
        ? Array < TweetGetPayload<S['select'][P]>>  : never
  } 
    : User
  : User
  ...
  type GetTweetGroupByPayload<T extends TweetGroupByArgs> = Promise<
    Array<
  ...
  export interface TweetDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, TweetGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTweetGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type TweetCreateManyUserInputEnvelope = {
    data: Enumerable<TweetCreateManyUserInput>
    skipDuplicates?: boolean
  }
